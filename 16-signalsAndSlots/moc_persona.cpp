...
QT_MOC_LITERAL(1, 8, 5), // "hablo"
QT_MOC_LITERAL(2, 14, 0), // ""
QT_MOC_LITERAL(3, 15, 7), // "escucha"
QT_MOC_LITERAL(4, 23, 8) // "palabras"

    },
    "Persona\0hablo\0\0escucha\0palabras"
};
...
void Persona::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->hablo((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->escucha((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Persona::hablo)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Persona::hablo(QString _t1)
{
